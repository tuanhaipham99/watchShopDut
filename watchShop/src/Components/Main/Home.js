...
export default class Login extends Component{
    ...
    gotoMen = () => {
        this.props.navigation.navigate("Men");
    }
    gotoWomen = () => {
        this.props.navigation.navigate("Women");
    }
        ...
        return(
            <View style={styles.mainContainer}>
                ...
                <View style={{flexDirection:"row", height:"6%"}}>
                    <TouchableOpacity onPress = {this.gotoMen}>
                        <Image source={require('../../assets/image/men1.jpg')} style={styles.imageHead}/>
                    </TouchableOpacity>
                    <View style={styles.space}></View>
                    <TouchableOpacity onPress={this.gotoWomen}>
                        <Image source={require('../../assets/image/women1111.jpg')} style={styles.imageHead}/>
                    </TouchableOpacity>
                </View>
